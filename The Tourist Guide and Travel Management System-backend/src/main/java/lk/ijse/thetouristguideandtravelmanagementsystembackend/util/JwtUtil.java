...
public class JwtUtil implements Serializable {
    ...
    public static final long JWT_TOKEN_VALIDITY = (long) (3 * 365.25 * 24 * 60 * 60);
    ...
    public String generateToken(UserDto userDto) {
        ...
        // Either add ROLE_ prefix here or handle in filter
        claims.put("role", userDto.getRole());  // Consider using "ROLE_" + userDto.getRole()
